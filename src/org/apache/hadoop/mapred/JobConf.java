...
public class JobConf extends Configuration {
  ...
  public static final String MAPRED_JOB_TASK_JAVA_OPTS = 
      "mapred.job.child.java.opts";
  /**
  ...
  public static final String MAPRED_JOB_TASK_ULIMIT = "mapred.job.child.ulimit";
  ...
  public static final String MAPRED_JOB_TASK_ENV = "mapred.job.child.env";
